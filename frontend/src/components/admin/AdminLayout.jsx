...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { path: '/admin/orders', icon: PackageIcon, label: 'Orders' },
    ...
    { path: '/admin/refunds', icon: MessageSquareIcon, label: 'Refunds' },
        ...
        <div className="flex items-center justify-between p-4 border-b border-white/10">
          {isSidebarOpen ? (
            <div className="flex items-center space-x-2">
              <span className="text-2xl font-bold text-white">⚙️ Admin</span>
            </div>
          ) : (
            <span className="text-2xl font-bold text-white mx-auto">⚙️</span>
          )}
          <button
