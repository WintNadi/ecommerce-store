...
import { ArrowRight, ShoppingBag, Star, Truck, Shield, Clock, Sparkles } from 'lucide-react';
...
const HomePage = () => {
  ...
  const features = [
    {
      ...
      color: 'bg-navy-100 dark:bg-navy-900/30',
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      {/* ============================================
          HERO SECTION - Updated with Navy
      ============================================ */}
      <section className="relative overflow-hidden bg-navy-500 dark:bg-navy-900">
        {/* Animated Background */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight">
                Discover Amazing
                <span className="block text-orange-300">Products</span>
                at Great Prices
              </h1>
              <p className="mt-6 text-lg sm:text-xl text-navy-100 max-w-lg mx-auto lg:mx-0">
                Shop the latest trends and best deals. From electronics to fashion, we have everything you need.
              </p>
              <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                <Link
                  to="/shop"
                  className="px-8 py-4 bg-orange-500 text-white font-semibold rounded-xl hover:bg-orange-600 transition-all shadow-lg hover:shadow-xl flex items-center gap-2 group"
                >
                  Start Shopping
              ...
              <div className="mt-8 flex gap-8 justify-center lg:justify-start">
                <div>
                  ...
                  <p className="text-sm text-navy-200">Products</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-white">5K+</p>
                  <p className="text-sm text-navy-200">Happy Customers</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-white">4.9★</p>
                  <p className="text-sm text-navy-200">Average Rating</p>
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:flex justify-center items-center">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-navy-400 to-orange-400 blur-3xl opacity-20 rounded-full"></div>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 120L60 110C120 100 240 80 360 70C480 60 600 60 720 65C840 70 960 80 1080 85C1200 90 1320 90 1380 90L1440 90V120H1380C1320 120 1200 120 1080 120H0Z" fill="currentColor" className="text-white dark:text-gray-900"/>
          </svg>
        </div>
      </section>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link
            to="/shop"
            className="flex items-center gap-2 text-navy-600 hover:text-navy-700 dark:text-navy-400 font-medium"
          >
            View All
      ...
      {/* ============================================
          CTA SECTION - Updated with Navy + Orange
      ============================================ */}
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="relative overflow-hidden bg-gradient-to-r from-navy-600 to-navy-700 dark:from-navy-800 dark:to-navy-900 rounded-3xl p-12 text-center">
          <div className="absolute inset-0 opacity-10">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                to="/shop"
                className="px-8 py-4 bg-orange-500 text-white font-semibold rounded-xl hover:bg-orange-600 transition-all shadow-lg"
              >
                Browse Products
              </Link>
              {!isAuthenticated && (
